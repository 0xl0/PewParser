...
if exist "%DIRECTORY%\%EXE_FILE%" (
    echo Premake5 found. Running premake5 with premake5.lua for VS2022...
    %DIRECTORY%\%EXE_FILE% --file=premake5.lua vs2022
    goto :end
)
...
if exist "%DIRECTORY%\%EXE_FILE%" (
    ...
    echo Running premake5 with premake5.lua for VS2022...
    %DIRECTORY%\%EXE_FILE% --file=premake5.lua vs2022
) else (
